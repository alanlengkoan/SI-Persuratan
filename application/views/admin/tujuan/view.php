...
<div class="modal fade" id="modal-input" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <form action="<?= admin_url() ?>/tujuan/add" method="POST" id="form-add">
                ...
                <div class="modal-body">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="inpkode" id="inpkode" class="form-control" value="<?= getKodeOtomatis('tujuan', 'TJ') ?>" readonly="readonly">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-sm-2 col-form-label">Nama</label>
                        <div class="col-sm-10">
                            <input type="text" name="inpnama" id="inpnama" class="form-control" placeholder="Masukkan tujuan">
                        </div>
                    </div>
                    <div class="form-group row">
