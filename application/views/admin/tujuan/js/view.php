...
<script>
        ...
        $(document).on('click', '#upd', function() {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $('.modal-title').html('Ubah Tujuan');

                    $('form').attr('action', '<?= admin_url() ?>/tujuan/upd');
    ...
    var untukBersihkanModal = function() {
        $(document).on('click', '#cls', function() {
            ...
            $('.modal-title').html('Tambah Tujuan');
            $('#inpkode').val('<?= getKodeOtomatis('tujuan', 'AS') ?>');
            $('#inpnama').val('');
            $('#inpalamat').val('');
            $('#inpketerangan').val('');
        });
